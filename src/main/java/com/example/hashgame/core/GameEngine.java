package com.example.hashgame.core;

import com.example.hashgame.model.HashGame;
import com.example.hashgame.exception.InvalidHashMoveException;

// TODO: redesign and make code clean without deleting or modifying existing component definitions
 ...
 */
	...
	public boolean hasWon() {
		...
		if(Math.abs(diagonals[0])==3) {
			itHasWon=true;
			this.whereHasWin= GameEngine.WINDIAGONAL0;
		} else if(Math.abs(diagonals[1])==3) {
			itHasWon=true;
			this.whereHasWin= GameEngine.WINDIAGONAL1;
		}
		return itHasWon;
	}
/**
